...
import { handleEvent, RPC } from '~/core/events';
import {
    ValidationError,
    exists,
    isEmail,
...
export default class AuthScene {
    ...
    onPlayerReady(playerMp: alt.Player) {
     ...
     */
    authenticatePlayer(playerMp: alt.Player) {
        alt.emitClient(playerMp, AuthConstants.Events.PLAYER_READY_FOR_AUTHENTICATION);
    }
